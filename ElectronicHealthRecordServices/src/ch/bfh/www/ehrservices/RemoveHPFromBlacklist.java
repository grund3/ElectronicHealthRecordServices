 ...
 */
            ...
            /**
            *  RemoveHPFromBlacklist bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveHPFromBlacklist
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeHPFromBlacklist",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeHPFromBlacklist",
    ...
    public static class Factory{
        ...
        */
        public static RemoveHPFromBlacklist parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveHPFromBlacklist object =
                new RemoveHPFromBlacklist();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeHPFromBlacklist".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveHPFromBlacklist)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
