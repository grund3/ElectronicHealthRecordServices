...
/**
 * RemoveOrganisationHPFromPatientResponse.java
 *
 ...
 */
            ...
            /**
            *  RemoveOrganisationHPFromPatientResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveOrganisationHPFromPatientResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.bfh.ch/ehrServices/",
                "removeOrganisationHPFromPatientResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeOrganisationHPFromPatientResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeOrganisationHPFromPatientResponse",
    ...
    public static class Factory{
        ...
        */
        public static RemoveOrganisationHPFromPatientResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveOrganisationHPFromPatientResponse object =
                new RemoveOrganisationHPFromPatientResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeOrganisationHPFromPatientResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveOrganisationHPFromPatientResponse)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
