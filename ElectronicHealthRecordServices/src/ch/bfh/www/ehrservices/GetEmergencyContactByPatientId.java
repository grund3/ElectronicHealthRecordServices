...
/**
 * GetEmergencyContactByPatientId.java
 *
 ...
 */
            ...
            /**
            *  GetEmergencyContactByPatientId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetEmergencyContactByPatientId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getEmergencyContactByPatientId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getEmergencyContactByPatientId",
    ...
    public static class Factory{
        ...
        */
        public static GetEmergencyContactByPatientId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEmergencyContactByPatientId object =
                new GetEmergencyContactByPatientId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getEmergencyContactByPatientId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEmergencyContactByPatientId)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
