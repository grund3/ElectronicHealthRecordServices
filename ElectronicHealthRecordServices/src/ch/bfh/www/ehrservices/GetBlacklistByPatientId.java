 ...
 */
            ...
            /**
            *  GetBlacklistByPatientId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBlacklistByPatientId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBlacklistByPatientId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBlacklistByPatientId",
    ...
    public static class Factory{
        ...
        */
        public static GetBlacklistByPatientId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBlacklistByPatientId object =
                new GetBlacklistByPatientId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBlacklistByPatientId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBlacklistByPatientId)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
