...
/**
 * GetAllDocumentsByPatientId.java
 *
 ...
 */
            ...
            /**
            *  GetAllDocumentsByPatientId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllDocumentsByPatientId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllDocumentsByPatientId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllDocumentsByPatientId",
    ...
    public static class Factory{
        ...
        */
        public static GetAllDocumentsByPatientId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllDocumentsByPatientId object =
                new GetAllDocumentsByPatientId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllDocumentsByPatientId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllDocumentsByPatientId)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
