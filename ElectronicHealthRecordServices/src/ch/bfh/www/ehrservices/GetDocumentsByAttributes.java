 ...
 */
            ...
            /**
            *  GetDocumentsByAttributes bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDocumentsByAttributes
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDocumentsByAttributes",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDocumentsByAttributes",
    ...
    public static class Factory{
        ...
        */
        public static GetDocumentsByAttributes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDocumentsByAttributes object =
                new GetDocumentsByAttributes();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDocumentsByAttributes".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDocumentsByAttributes)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
