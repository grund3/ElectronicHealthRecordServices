...
/**
 * GetVisibleDocumentsForOrgaHP.java
 *
 ...
 */
            ...
            /**
            *  GetVisibleDocumentsForOrgaHP bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetVisibleDocumentsForOrgaHP
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getVisibleDocumentsForOrgaHP",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getVisibleDocumentsForOrgaHP",
    ...
    public static class Factory{
        ...
        */
        public static GetVisibleDocumentsForOrgaHP parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetVisibleDocumentsForOrgaHP object =
                new GetVisibleDocumentsForOrgaHP();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getVisibleDocumentsForOrgaHP".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetVisibleDocumentsForOrgaHP)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
