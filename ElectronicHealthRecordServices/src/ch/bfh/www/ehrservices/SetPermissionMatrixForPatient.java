...
/**
 * SetPermissionMatrixForPatient.java
 *
 ...
 */
            ...
            /**
            *  SetPermissionMatrixForPatient bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetPermissionMatrixForPatient
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setPermissionMatrixForPatient",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setPermissionMatrixForPatient",
    ...
    public static class Factory{
        ...
        */
        public static SetPermissionMatrixForPatient parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetPermissionMatrixForPatient object =
                new SetPermissionMatrixForPatient();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setPermissionMatrixForPatient".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetPermissionMatrixForPatient)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
