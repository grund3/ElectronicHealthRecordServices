...
/**
 * GetSpecialPermissionByPatient.java
 *
 ...
 */
            ...
            /**
            *  GetSpecialPermissionByPatient bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSpecialPermissionByPatient
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSpecialPermissionByPatient",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSpecialPermissionByPatient",
    ...
    public static class Factory{
        ...
        */
        public static GetSpecialPermissionByPatient parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSpecialPermissionByPatient object =
                new GetSpecialPermissionByPatient();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSpecialPermissionByPatient".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSpecialPermissionByPatient)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
