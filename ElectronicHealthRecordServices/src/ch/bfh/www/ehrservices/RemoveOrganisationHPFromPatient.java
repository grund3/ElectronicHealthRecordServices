...
/**
 * RemoveOrganisationHPFromPatient.java
 *
 ...
 */
            ...
            /**
            *  RemoveOrganisationHPFromPatient bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveOrganisationHPFromPatient
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeOrganisationHPFromPatient",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeOrganisationHPFromPatient",
    ...
    public static class Factory{
        ...
        */
        public static RemoveOrganisationHPFromPatient parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveOrganisationHPFromPatient object =
                new RemoveOrganisationHPFromPatient();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeOrganisationHPFromPatient".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveOrganisationHPFromPatient)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
