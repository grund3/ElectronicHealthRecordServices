 ...
 */
            ...
            /**
            *  SetEmergencyContact bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetEmergencyContact
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setEmergencyContact",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setEmergencyContact",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localEmergencyContact.serialize(new javax.xml.namespace.QName("","emergencyContact"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localEmergencyContact);
    ...
    public static class Factory{
        ...
        */
        public static SetEmergencyContact parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetEmergencyContact object =
                new SetEmergencyContact();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setEmergencyContact".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetEmergencyContact)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
