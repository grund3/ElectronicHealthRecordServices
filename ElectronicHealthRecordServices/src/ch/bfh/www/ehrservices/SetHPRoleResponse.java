 ...
 */
            ...
            /**
            *  SetHPRoleResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetHPRoleResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setHPRoleResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setHPRoleResponse",
    ...
    public static class Factory{
        ...
        */
        public static SetHPRoleResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetHPRoleResponse object =
                new SetHPRoleResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setHPRoleResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetHPRoleResponse)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
