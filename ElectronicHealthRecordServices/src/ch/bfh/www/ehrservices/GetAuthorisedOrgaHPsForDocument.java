...
/**
 * GetAuthorisedOrgaHPsForDocument.java
 *
 ...
 */
            ...
            /**
            *  GetAuthorisedOrgaHPsForDocument bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAuthorisedOrgaHPsForDocument
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAuthorisedOrgaHPsForDocument",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAuthorisedOrgaHPsForDocument",
    ...
    public static class Factory{
        ...
        */
        public static GetAuthorisedOrgaHPsForDocument parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAuthorisedOrgaHPsForDocument object =
                new GetAuthorisedOrgaHPsForDocument();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAuthorisedOrgaHPsForDocument".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAuthorisedOrgaHPsForDocument)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
