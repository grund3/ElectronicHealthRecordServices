 ...
 */
            ...
            /**
            *  GetConfidentialityLevels bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetConfidentialityLevels
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getConfidentialityLevels",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getConfidentialityLevels",
    ...
    public static class Factory{
        ...
        */
        public static GetConfidentialityLevels parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetConfidentialityLevels object =
                new GetConfidentialityLevels();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getConfidentialityLevels".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetConfidentialityLevels)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
