 ...
 */
            ...
            /**
            *  GetWhitelistByPatientId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetWhitelistByPatientId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getWhitelistByPatientId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getWhitelistByPatientId",
    ...
    public static class Factory{
        ...
        */
        public static GetWhitelistByPatientId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetWhitelistByPatientId object =
                new GetWhitelistByPatientId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getWhitelistByPatientId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetWhitelistByPatientId)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
