 ...
 */
            ...
            /**
            *  SetSpecialPermission bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetSpecialPermission
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for HealthProfessionalID
                        */

                        
                                    protected int localHealthProfessionalID ;
                           ...
                           */
                           public  int getHealthProfessionalID(){
                               return localHealthProfessionalID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param HealthProfessionalID
                               */
                               public void setHealthProfessionalID(int param){
                            
                                            this.localHealthProfessionalID=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setSpecialPermission",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setSpecialPermission",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "healthProfessionalID", xmlWriter);
                             
                                               if (localHealthProfessionalID==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("healthProfessionalID cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHealthProfessionalID));
                                               }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHealthProfessionalID));
    ...
    public static class Factory{
        ...
        */
        public static SetSpecialPermission parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetSpecialPermission object =
                new SetSpecialPermission();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setSpecialPermission".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetSpecialPermission)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","healthProfessionalID").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"healthProfessionalID" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setHealthProfessionalID(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
