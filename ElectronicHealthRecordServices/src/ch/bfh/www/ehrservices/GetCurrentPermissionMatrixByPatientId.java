...
/**
 * GetCurrentPermissionMatrixByPatientId.java
 *
 ...
 */
            ...
            /**
            *  GetCurrentPermissionMatrixByPatientId bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCurrentPermissionMatrixByPatientId
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getCurrentPermissionMatrixByPatientId",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getCurrentPermissionMatrixByPatientId",
    ...
    public static class Factory{
        ...
        */
        public static GetCurrentPermissionMatrixByPatientId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCurrentPermissionMatrixByPatientId object =
                new GetCurrentPermissionMatrixByPatientId();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCurrentPermissionMatrixByPatientId".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCurrentPermissionMatrixByPatientId)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
