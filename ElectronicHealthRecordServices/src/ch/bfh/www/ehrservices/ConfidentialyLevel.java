 ...
 */
            ...
            /**
            *  ConfidentialyLevel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ConfidentialyLevel
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ConfidentialyLevel
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ConfidentialyLevel",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ConfidentialyLevel",
    ...
    public static class Factory{
        ...
        */
        public static ConfidentialyLevel parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConfidentialyLevel object =
                new ConfidentialyLevel();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ConfidentialyLevel".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConfidentialyLevel)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
