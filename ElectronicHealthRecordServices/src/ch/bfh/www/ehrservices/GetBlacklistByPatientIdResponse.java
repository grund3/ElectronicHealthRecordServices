...
/**
 * GetBlacklistByPatientIdResponse.java
 *
 ...
 */
            ...
            /**
            *  GetBlacklistByPatientIdResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBlacklistByPatientIdResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.bfh.ch/ehrServices/",
                "getBlacklistByPatientIdResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBlacklistByPatientIdResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBlacklistByPatientIdResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetBlacklistByPatientIdResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBlacklistByPatientIdResponse object =
                new GetBlacklistByPatientIdResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBlacklistByPatientIdResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBlacklistByPatientIdResponse)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
