...
/**
 * SetPermissionMatrixForPatientResponse.java
 *
 ...
 */
            ...
            /**
            *  SetPermissionMatrixForPatientResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetPermissionMatrixForPatientResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.bfh.ch/ehrServices/",
                "setPermissionMatrixForPatientResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setPermissionMatrixForPatientResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setPermissionMatrixForPatientResponse",
    ...
    public static class Factory{
        ...
        */
        public static SetPermissionMatrixForPatientResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetPermissionMatrixForPatientResponse object =
                new SetPermissionMatrixForPatientResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setPermissionMatrixForPatientResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetPermissionMatrixForPatientResponse)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
