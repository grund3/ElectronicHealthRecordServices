...
/**
 * RemoveEmergencyContactResponse.java
 *
 ...
 */
            ...
            /**
            *  RemoveEmergencyContactResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeEmergencyContactResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeEmergencyContactResponse",
    ...
    public static class Factory{
        ...
        */
        public static RemoveEmergencyContactResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveEmergencyContactResponse object =
                new RemoveEmergencyContactResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeEmergencyContactResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveEmergencyContactResponse)ch.bfh.www.ehrservices.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
